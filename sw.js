...
const CORE = [
  ...
  "./assets/manifests/assets.json", "./assets/sprites/player/hunter-walk-sheet.png", "./assets/sprites/player/hunter-action-sheet-v7.png", "./assets/sprites/npcs/farmer-vaclav-v2.png", "./assets/sprites/npcs/farmer-vaclav-v7.png", "./assets/sprites/hazards/tractor-chlum-v7.png", "./assets/sprites/foreground/chlum-wet-verge-v7.png", "./assets/sprites/npcs/rival-karel-v2.png", "./assets/sprites/npcs/forester-jan-v2.png", "./assets/sprites/npcs/expert-eva-v2.png", "./assets/sprites/npcs/thief-franta-v2.png",
  "./assets/sprites/findings/vltavin-common.png", "./assets/sprites/findings/vltavin-rare.png", "./assets/sprites/findings/vltavin-standard.png", "./assets/sprites/findings/vltavin-nesmen.png", "./assets/sprites/findings/vltavin-besednice-hedgehog.png", "./assets/sprites/foreground/nesmen-forest-edge-v7.png",
  "./assets/textures/terrain/chlum-field.png", "./assets/textures/terrain/chlum-furrows.png", "./assets/textures/terrain/chlum-plate-v7.svg", "./assets/textures/terrain/chlum-plate-v7.png", "./assets/textures/terrain/nesmen-forest-floor.png", "./assets/textures/terrain/nesmen-sand-profile.png", "./assets/textures/terrain/nesmen-reference-clearing-v2.png", "./assets/textures/terrain/nesmen-forest-plate-v7.png", "./assets/textures/terrain/besednice-quarry.png", "./assets/textures/terrain/besednice-clay-quarry-v1.png", "./assets/textures/terrain/slavia-malse-exterior-v1.png",
