...
| Grafika #5 | Dílčí assety vznikly mimo společný runtime | Asset manifest + skutečné PNG/GLB v repozitáři | Rozpočty, pivoty, průhlednost, načtení bez 404 |
...
| Master #8 | Aktivní | Udržovat pořadí a odkazy na PR | Žádný paralelní release mimo frontu |
