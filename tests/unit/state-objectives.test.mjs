...
test("cloneGameState oddělí vnořené mutable struktury", () => {
...
test("migrateLegacySave může odstranit zdroj až po převodu", () => {
...
test("Besednice používá správné texty jednotlivých fází", () => {
...
test("progress všech objektivů zůstává v rozsahu 0 až 1", () => {
  const cases = [
